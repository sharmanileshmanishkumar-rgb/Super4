...
@app.route('/api/geeksforgeeks/<topic>', methods=['GET'])
def get_geeksforgeeks_content(topic):
    try:
        # Simulate GeeksforGeeks API call
        ...
        mock_content = {
            ...
            'articles': [
                ...
                },
                {
                    ...
                    'url': f'https://www.geeksforgeeks.org/{topic.lower().replace(" ", "-")}-advanced/',
                    'difficulty': 'Advanced',
                    'read_time': '15 min'
                }
            ]
        ...
        return jsonify(mock_content), 200
...
@app.route('/api/khan_academy/<subject>', methods=['GET'])
def get_khan_academy_content(subject):
    try:
        # Simulate Khan Academy API call
        mock_content = {
            'subject': subject,
            'courses': [
                {
                    'title': f'{subject} Fundamentals',
                    'description': f'Learn the basics of {subject}',
                    'duration': '2 hours',
                    'level': 'Beginner'
                },
                {
                    'title': f'Advanced {subject}',
                    'description': f'Deep dive into advanced {subject} concepts',
                    'duration': '4 hours',
                    'level': 'Advanced'
                }
            ]
